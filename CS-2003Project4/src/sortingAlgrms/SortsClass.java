...
public class SortsClass {
	...
	private static void choosePivot(Comparable[] theArray, int first, int last) {
		...
		int num = rand.nextInt((last));
		Comparable firstPlaceHolder = theArray[first];
		Comparable numPlaceHolder = theArray[num];
		theArray[first] = numPlaceHolder;
		theArray[num] = firstPlaceHolder;

	} // end choosePivot

	private static int partition(Comparable[] theArray, int first, int last, boolean random) {
		// ---------------------------------------------------------
...
//			choosePivot(theArray, first, last);
	...
	public static void quickSort(Comparable[] theArray, int first, int last, boolean random) {
		// ---------------------------------------------------------
		// Sorts the items in an array into ascending order.
		// Precondition: theArray[first..last] is an array.
		// Postcondition: theArray[first..last] is sorted.
		...
		if (first < last) {
			...
			pivotIndex = partition(theArray, first, last, random);
			// sort regions S1 and S2
			quickSort(theArray, first, pivotIndex - 1, random);
			quickSort(theArray, pivotIndex + 1, last, random);
		} // end if
	} // end quickSort

	public static void hybridmergesort(Comparable[] theArray, int first, int last, int recurrsiveHault) {
		// ---------------------------------------------------------
		// Sorts the items in an array into ascending order.
		// Precondition: theArray[first..last] is an array.
		// Postcondition: theArray[first..last] is sorted in
		...
		if (first + recurrsiveHault < last) {
			...
			SortsClass.insertionSort(theArray, theArray.length);
		}
	} // end mergesort
